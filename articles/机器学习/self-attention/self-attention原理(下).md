...
<img src="../../../images/self-attention/self-attention原理.png" />

1、首先，我们来看 `α11` 的计算过程。
<img src="../../../images/self-attention/self-attention-2.png" width="300" />

2、从上图可知，**α11 = q1 · k1**，点乘 `dot product` 可以写成 `k1 的逆` 与 `q1` 做矩阵相乘。

<img src="../../../images/self-attention/self-attention-4.png" width="300" />

3、同理，**α12 = q1 · k2**，即可以写成 `k2 的逆` 与 `q1` 做矩阵相乘。

<img src="../../../images/self-attention/self-attention-5.png" width="300" />
...
<img src="../../../images/self-attention/self-attention-6.png" width="400" />

5、我们把所有的`q1、q2、q3、q4` 以及 `k1、k2、k3、k4` 加进来计算。可以分别得到 `α11-α14`，`α21-α24`、`α31-α34`、`α41-α44`...

<img src="../../../images/self-attention/self-attention-7.png" width="500" />
...
<img src="../../../images/self-attention/self-attention-8.png" width="500" />
...
<img src="../../../images/self-attention/self-attention-9.png" width="600" />


8、把`self-attention`的计算过程总结一下，可以得到 ⬇️

原理就是矩阵的运算，通过矩阵取逆、矩阵相乘等操作来实现相关的计算。
<img src="../../../images/self-attention/self-attention-10.png" width="600" />