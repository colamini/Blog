...
<img src="../../../images/self-attention/单输入输出.png" width="300" />
...
<img src="../../../images/self-attention/多输入输出-1.png" width="500" />

很简单，我们把这4个输入拆开成单个，逐一输入计算就完事～或者干脆作为一个矩阵丢进去计算也行！这个问题暂且就解决了。


<img src="../../../images/self-attention/多输入输出-2.png" width="500" />
...
<img src="../../../images/self-attention/self-attention-1.png" width="500" />
...
<img src="../../../images/self-attention/self-attention-2.png" width="400" />
...
<img src="../../../images/self-attention/向量点乘的计算过程.png" width="500"/>
...
<img src="../../../images/self-attention/向量点乘的几何意义.png" width="300"/>
...
<img src="../../../images/self-attention/self-attention-3.png" />
