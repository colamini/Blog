...
<img src="../../../images/self-attention/prenet.png" />
...
```
<img src="../../../images/self-attention/permute.png" />
...
# out: (batch size, length, d_model)
```
<img src="../../../images/self-attention/encoder_layer.png" />
...
<img src="../../../images/self-attention/transpose.png" />
...
<img src="../../../images/self-attention/mean.png" />
...
<img src="../../../images/self-attention/argmax.png" />
还是用表格来表示一下比较好理解 ⬇️
